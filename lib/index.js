module.exports = {
  ...
  rules: {
    ...
    '@typescript-eslint/prefer-ts-expect-error': 'error', // TODO: Enable when TS 3.9 is out
  ...
  overrides: [
    {
      ...
      rules: {
        ...
        'jest/prefer-mock-promise-shorthand': 'off', // as of the current eslint version this rule is wrong (it replaces replaces mockImplemantation(a => Promise.resolve(f(a))) with mockResolvedValue(f(a)))
        'jest/unbound-method': 'off', // redundant with the typescript-eslint one
        //#endregion Jest
      },
    },
  ],
